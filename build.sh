...
tar -czvf linux_amd64.tar.gz verify-chinese-ID-number conf/area_code.json
...
tar -czvf windows_amd64.tar.gz verify-chinese-ID-number.exe conf/area_code.json
